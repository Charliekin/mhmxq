...
public final class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setTitleBarTitle(R.string.scan, true);
        ButterKnife.bind(this);

        mTvScan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CaptureActivity.this, MyQrActivity.class));
            }
        });
        hasSurface = false;
    ...
    protected void onResume() {
        ...
        mVfwScan.setCameraManager(cameraManager);
        handler = null;
        lastResult = null;

        SurfaceHolder surfaceHolder = mSvScan.getHolder();
    ...
    private boolean showScanResult(String content) {
        if (content == null) {
            ...
            intent.putExtra(Extras.Companion.getSCAN_RESULT(), content);
